...
# python -u fcn_xs.py --model=fcn32s --prefix=models/FCN32s_ResNet --epoch=42 --init-type=resnet --retrain

## train fcn-16s model
# python -u fcn_xs.py --model=fcn16s --prefix=models/FCN32s_VGG16 --epoch=31 --init-type=fcnxs
# python -u fcn_xs.py --model=fcn16s --prefix=models/FCN32s_ResNet --epoch=44 --init-type=fcnxs
# python -u fcn_xs.py --model=fcn16s --prefix=models/FCN16s_ResNet --epoch=15 --init-type=fcnxs --retrain
